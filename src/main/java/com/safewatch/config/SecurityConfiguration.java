...
import com.safewatch.auth.internal.security.JwtFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity security) {
        return security
                ...
                .authorizeHttpRequests(requests -> {
                    requests.requestMatchers("/api/v1/auth/login", "/api/v1/auth/refresh", "/api/v1/auth/register", "/api/v1/auth/verify", "/api/v1/auth/forgot/password").permitAll()
                            .requestMatchers("/api/admin/*").hasAuthority("ROLE_ADMIN")
                            .requestMatchers("/api/v1/incident/*").authenticated()
